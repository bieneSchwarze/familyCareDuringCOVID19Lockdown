...
DAT$groupInt <- NA
DAT$groupInt[DAT$careTime.2019 %in% 0 & DAT$careTime.2020 %in% 0] <- 0 # non-caregivers
DAT$groupInt[DAT$careTime.2019 %in% c(1,2) & DAT$careTime.2020 %in% c(1,2)] <- 1 # continuing & low-int
DAT$groupInt[DAT$careTime.2019 >2 & DAT$careTime.2020 >2] <- 2 # continuing & high-int
DAT$groupInt[DAT$careTime.2019 %in% 0 & DAT$careTime.2020 %in% c(1,2)] <- 3 # new caregivers & low-int
DAT$groupInt[DAT$careTime.2019 %in% 0 & DAT$careTime.2020 >2] <- 4 # new caregivers & high-int
DAT$groupInt[DAT$careTime.2019 >2 & DAT$careTime.2020 %in% c(1,2)] <- 5 # continuing & switching from high to low-int  
DAT$groupInt[DAT$careTime.2019 %in% c(1,2) & DAT$careTime.2020 >2] <- 6 # continuing & switching from low to high-int  
DAT$groupInt[DAT$careTime.2019 %in% c(1,2) & DAT$careTime.2020 %in% 0] <- 7 # stopping to care from low-int
DAT$groupInt[DAT$careTime.2019 >2 & DAT$careTime.2020 %in% 0] <- 8 # stopping to care from high-int  
table(DAT$groupInt, exclude=NULL)
...
for(i in 1:imp$m){
  ...
  DAT_fe_i$groupInt[DAT_fe_i$careTime.2019 %in% 0 & DAT_fe_i$careTime.2020 %in% 0] <- 0 # non-caregivers
  DAT_fe_i$groupInt[DAT_fe_i$careTime.2019 %in% c(1,2) & DAT_fe_i$careTime.2020 %in% c(1,2)] <- 1 # continuing & low-int
  DAT_fe_i$groupInt[DAT_fe_i$careTime.2019 >2 & DAT_fe_i$careTime.2020 >2] <- 2 # continuing & high-int
  DAT_fe_i$groupInt[DAT_fe_i$careTime.2019 %in% 0 & DAT_fe_i$careTime.2020 %in% c(1,2)] <- 3 # new caregivers & low-int
  DAT_fe_i$groupInt[DAT_fe_i$careTime.2019 %in% 0 & DAT_fe_i$careTime.2020 >2] <- 4 # new caregivers & high-int
  DAT_fe_i$groupInt[DAT_fe_i$careTime.2019 >2 & DAT_fe_i$careTime.2020 %in% c(1,2)] <- 5 # continuing & switching from high to low-int  
  DAT_fe_i$groupInt[DAT_fe_i$careTime.2019 %in% c(1,2) & DAT_fe_i$careTime.2020 >2] <- 6 # continuing & switching from low to high-int  
  DAT_fe_i$groupInt[DAT_fe_i$careTime.2019 %in% c(1,2) & DAT_fe_i$careTime.2020 %in% 0] <- 7 # stopping to care from low-int
  DAT_fe_i$groupInt[DAT_fe_i$careTime.2019 >2 & DAT_fe_i$careTime.2020 %in% 0] <- 8 # stopping to care from high-int  
...
# --------------------------------------------------------------
# DV Life Satisfaction for 2019, 2020 (using imputed data)
# --------------------------------------------------------------
...
# ------------
# Beta Coefficients
beta_depress <- cbind(res_Depr_2020[6:11,], "Depression")
colnames(beta_depress) <- c("Group", "Estimate", "CI_low", "CI_up", "Measure")
beta_lifeSatis <- cbind(res_LS_2020[6:11,], "Life Satisfaction")
...
zp <- zp + xlab("") + ylab("beta coefficients (year=2020 * care group)")
